  ...
  <body>
    <div class="header sticky sticky--top js-header">
      ...
      <div class="parent">
          ...
          <input id="player">
          <?php
          // echo "Сортировать по: <select id=\"order\" name=\"Order\">";
          // // if ($order=="timemark") {
          // //     echo	"	<option selected value=\"timemark\"> Time </option>";
          // // } else {
          // //     echo	"	<option value=\"timemark\"> Time </option>";
          // // }
          // if ($order=="nick") {
          ...
          // }
          // if ($order=="clan") {
          //     echo	"	<option selected value=\"clan_id\"> Клан </option>";
          // } else {
          //     echo	"	<option value=\"clan_id\"> Клан </option>";
          // }
          // if ($era_selected!=-1) {
          //     if ($order=="fragse") {
          ...
          // }
          // echo " </select>";
          // echo "<select id=\"order_way\" name=\"Order_way\">";
          // if ($order_way=="desc") {
    ...
    // eras_data();
      ...
      function create () {
        ...
        $.ajax({
          ...
          type: "post", //request type,
          dataType: 'json',
          data: {type:"index", datee: date,order: $('#order').val(),order_way: $('#order_way').val(),clan:$('#clans').val()},
          async: false, // HERE
          success:function(result){
            // document.getElementById("id1").remove();
            // console.log(data);
